...
class EventHall(db.Model, UserMixin):
    ...
    def validate_eventhall(owner, name, deposit_price, instant_booking = False, description = None, street_address=None, place_number=None, images=None):
        ...
        return [None, EventHall(owner=owner, name=name, deposit_price=deposit_price, instant_booking=instant_booking, description=description, street_address=street_address, place_number=place_number, images=images)]
